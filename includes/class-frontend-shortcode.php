    ...
    private function render_info_step($config) {
        ...
        <div class="dmr-step-content" id="dmr-step-2">
            ...
            <?php if ($fields['full_name']['enabled'] ?? true) : ?>
                <div class="dmr-field">
                    <label for="full_name">Full Name <?php if ($fields['full_name']['required'] ?? true) echo '<span class="required">*</span>'; ?></label>
                    <input type="text" id="full_name" name="full_name" <?php if ($fields['full_name']['required'] ?? true) echo 'required'; ?>>
                </div>
            <?php endif; ?>
            
            <?php if ($fields['email']['enabled'] ?? true) : ?>
                <div class="dmr-field">
                    <label for="email">Email <?php if ($fields['email']['required'] ?? true) echo '<span class="required">*</span>'; ?></label>
                    <input type="email" id="email" name="email" <?php if ($fields['email']['required'] ?? true) echo 'required'; ?>>
                </div>
            <?php endif; ?>
            
            <?php if ($fields['phone']['enabled'] ?? true) : ?>
                <div class="dmr-field">
                    <label for="phone">Phone <?php if ($fields['phone']['required'] ?? false) echo '<span class="required">*</span>'; ?></label>
                    <input type="tel" id="phone" name="phone" <?php if ($fields['phone']['required'] ?? false) echo 'required'; ?>>
                </div>
            <?php endif; ?>
        ...
        <div class="dmr-step-content" id="dmr-step-3">
            ...
            <div class="dmr-field dmr-checkbox-field">
                <label>
                    ...
                    <?php echo esc_html($config['consent_text'] ?? 'I agree to be contacted.'); ?> <span class="required">*</span>
                </label>
            </div>
            
            <div class="dmr-disclaimer">
                <p><strong>Disclaimer:</strong> This self-check is for informational purposes only and does not constitute a medical diagnosis or professional advice. If you are experiencing severe distress, please contact a healthcare professional or crisis helpline.</p>
            </div>
    ...
    private function render_results() {
        ...
        <div class="dmr-results-wrapper">
            ...
            <div class="dmr-results-footer">
                <p>A copy of your results has been sent to our team. We may reach out to you at the contact information you provided.</p>
            </div>
        </div>
        <?php
        return ob_get_clean();
