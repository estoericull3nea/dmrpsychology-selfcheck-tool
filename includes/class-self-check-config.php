    ...
    public function render_page()
    {
        ...
        <div class="wrap dmr-builder-wrap">
            ...
            <div class="dmr-stepper">
                <div
                    class="dmr-stepper-item <?php echo $this->current_step >= 1 ? 'active' : ''; ?> <?php echo $this->current_step > 1 ? 'completed' : ''; ?>">
                    <span class="dmr-stepper-number">1</span>
                    <span class="dmr-stepper-label">Quiz Setup</span>
                </div>
                <div
                    class="dmr-stepper-item <?php echo $this->current_step >= 2 ? 'active' : ''; ?> <?php echo $this->current_step > 2 ? 'completed' : ''; ?>">
        ...
        <div class="dmr-step-content">
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        <input type="text" id="quiz_title" name="title" value="<?php echo esc_attr($config['title'] ?? ''); ?>"
                            class="regular-text">
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <textarea id="quiz_intro" name="intro" rows="3"
                            class="large-text"><?php echo esc_textarea($config['intro'] ?? ''); ?></textarea>
                    </td>
                </tr>
            </table>
            ...
            <div class="dmr-questions-list">
                ...
                for ($i = 0; $i < 10; $i++) {
                    ...
                    <div class="dmr-question-item">
                        ...
                        <textarea name="questions[<?php echo $i; ?>]" rows="2"
                            class="large-text"><?php echo esc_textarea($questions[$i] ?? ''); ?></textarea>
                    </div>
                    <?php
                }
                ?>
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        <textarea id="rec_low" name="recommendations[low]" rows="2"
                            class="large-text"><?php echo esc_textarea($config['recommendations']['low'] ?? ''); ?></textarea>
                    </td>
                </tr>
                <tr>
                    <th><label for="rec_moderate">Moderate Stress (14-26)</label></th>
                    <td>
                        <textarea id="rec_moderate" name="recommendations[moderate]" rows="2"
                            class="large-text"><?php echo esc_textarea($config['recommendations']['moderate'] ?? ''); ?></textarea>
                    </td>
                </tr>
                <tr>
                    <th><label for="rec_high">High Stress (27-40)</label></th>
                    <td>
                        <textarea id="rec_high" name="recommendations[high]" rows="2"
                            class="large-text"><?php echo esc_textarea($config['recommendations']['high'] ?? ''); ?></textarea>
                    </td>
                </tr>
            </table>

            <p class="submit">
                <a href="<?php echo admin_url('admin.php?page=dmr-self-check&step=2'); ?>" class="button button-primary">Next:
                    Info Capture</a>
            </p>
        </div>
        <?php
    ...
    private function render_step_info($config)
    {
        ...
        <div class="dmr-step-content">
                ...
                <tr>
                    ...
                    <td>
                        <textarea id="consent_text" name="consent_text" rows="2"
                            class="large-text"><?php echo esc_textarea($config['consent_text'] ?? ''); ?></textarea>
            ...
            <p class="submit">
                ...
                <a href="<?php echo admin_url('admin.php?page=dmr-self-check&step=3'); ?>" class="button button-primary">Next:
                    Review</a>
            </p>
        </div>
        <?php
    ...
    private function render_step_review($config)
    {
        ...
        <div class="dmr-step-content">
            ...
            <div class="dmr-review-section">
                ...
                <button type="button" class="button" onclick="navigator.clipboard.writeText('[dmr_self_check]')">Copy
                    Shortcode</button>
            </div>
